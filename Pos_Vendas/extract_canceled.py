...
# cancelados
navegador.find_element(By.XPATH, '//*[@id="board-selector"]/div/div[4]').click()
time.sleep(5)

# data inicio
navegador.find_element(By.XPATH, '//*[@id="input_67"]').clear()
navegador.find_element(By.XPATH, '//*[@id="input_67"]').send_keys('01/01/2010')
time.sleep(5)
navegador.find_element(By.XPATH, "//body").click()

# gerar relatório
navegador.find_element(By.XPATH, '//*[@id="configuracao-geral-servico-editar"]/div[2]/div/div/div[1]/div/div[5]/button').click()
time.sleep(5)
...
navegador.find_element(By.XPATH, '//*[@id="dialogContent_178"]/md-checkbox/div[2]/span').click()
time.sleep(3)
