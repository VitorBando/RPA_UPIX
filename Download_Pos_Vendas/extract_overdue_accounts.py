...
time.sleep(5)
navegador.find_element(By.XPATH, '//*[@id="select_value_label_90"]/span[1]').click()
navegador.find_element(By.XPATH, '//*[@id="select_option_114"]').click()
time.sleep(5)
...
navegador.find_element(By.XPATH, '//*[@id="dialogContent_184"]/md-checkbox/div[2]/span').click()
time.sleep(3)
navegador.find_element(By.XPATH, '/html/body/div[5]/md-dialog/form/md-toolbar/div/div/button[3]').click()
time.sleep(3)
